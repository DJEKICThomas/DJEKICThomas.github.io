const translations = {
  fr: {
    ...
    projectNoVideo: 'Pas de vidéo disponible pour ce projet.',
    ...
    project4Text: 'Projet de cours Flutter avec CRUD, gestion de plusieurs stocks, scan de codes-barres, vision long terme et étude de marché.',
    project4Code: 'Voir le code source + Read.Me (screens de l\'application)',
    project5Title: 'Projet 5 — Carnet de voyage interactif',
    project5Text: 'Application web personnelle développée en HTML5, CSS et JavaScript, intégrant l’API Leaflet. Elle permet de documenter ses vacances jour par jour et de marquer ses étapes sur une carte. (Note : l’authentification n’étant pas encore finalisée, vous pouvez vous connecter avec n’importe quels identifiants).',
    projectVideoComingSoon: 'Vidéo à venir pour ce projet.',
  ...
  en: {
    ...
    projectNoVideo: 'No video available for this project.',
    ...
    project4Text: 'Course project in Flutter with CRUD, multiple inventory management, barcode scanning, long-term vision and market research.',
    project4Code: 'View source code + Read.Me (app screens)',
    project5Title: 'Project 5 — Interactive Travel Journal',
    project5Text: 'A personal web application built with HTML5, CSS, and JavaScript, leveraging the Leaflet API. It allows users to document vacations day-by-day and map out their journey. (Note: authentication is simulated; you can log in using any credentials).',
    projectVideoComingSoon: 'Video coming soon for this project.',
    contactKicker: 'Contact',
